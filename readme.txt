...
This isn't automated as of yet, but supposodly could be. If doing this however, must be careful not to change the network code of any of the borehole stations, as these are correctly labelled 'UM'.
